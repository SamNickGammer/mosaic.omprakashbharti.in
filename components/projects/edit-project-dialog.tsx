...
import { useAgents, useProject, useUpdateProject } from "@/hooks/queries";
...
export function EditProjectDialog({
  ...
  // Hydrate the form whenever the dialog opens with fresh project data.
  useEffect(() => {
    if (open && project) {
      ...
      setPrimaryAgentId(project.primaryAgentId ?? "");
      setSecondaryIds(
        new Set(
          project.agents
      ...
      <DialogContent className="max-h-[85vh] overflow-y-auto sm:max-w-lg">
        <form onSubmit={onSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>
              Update project details and agent assignments.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="edit-context">Project context</Label>
              <Textarea
                id="edit-context"
                value={context}
